...
<?php
session_start();
// Никакой проверки авторизации — это форма входа!
?>
        ...
        <div class="block-header" data-bs-theme="dark">
            <div class="block-header__container" style="display: flex; justify-content: center;">
                <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="../index.php">
                            <img src="../img/logo.webp" alt="Точка роста" width="50" height="50">
                        </a>
                    </div>
                </nav>
            </div>
                ...
                <div class="container">
                    <div class="form__inner">
                        ...
                        <div class="form__content">
                            <form action="../php/signin.php" class="content__form" method="post">
                                <label class="input-label" for="login">Логин</label>
                                <input type="text" class="form__input" name="login" placeholder="Введите логин" required>
                                <label class="input-label" for="password">Пароль</label>
                                <input type="password" class="form__input" name="password" placeholder="Введите пароль" required>
                                <input class="form-btn btn-custom2" type="submit" value="Отправить">
                                <?php if (!empty($_SESSION['message'])): ?>
                                    <p class="input-label error-message">
